...
namespace Squrl.Migrations
{
    ...
    [Migration("20260713170735_RenamePurchaseOrderItemToItemInPurchaseOrderDetails")]
    partial class RenamePurchaseOrderItemToItemInPurchaseOrderDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Squrl.App.Models.PurchaseOrderDetail", b =>
                {
                    ...
                    b.HasIndex("ItemId")
                        .HasDatabaseName("ix_purchase_order_detail_item_id");
            ...
            modelBuilder.Entity("Squrl.App.Models.PurchaseOrderDetail", b =>
                {
                    b.HasOne("Squrl.App.Models.Item", "Item")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_purchase_order_detail_items_item_id");
